...
test.describe('File Uploading', async () => {
    ...
    test.only('Multiple file upload', async()=>{
      ...
      await page.locator('input[type="file"]').setInputFiles(['D:/Ibexlabs/Automation/Demo/KT/Git-Demo/package.json','D:/Ibexlabs/Automation/Demo/KT/Git-Demo/playwright-tests/files/basic.txt'])
      // await page.pause();
